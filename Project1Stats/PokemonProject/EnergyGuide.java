...
public interface EnergyGuide {                                                       // Interface EnergyGuide created to be implemented by EnergyCard superclass and inherited by each energy card subclass.                                 
    void attachEnergy(Player player);                                                // Method attachEnergy created to be implemented by EnergyCard class to allow player to attach energy card to their active Pokemon (to be used to attack opposing active pokemon).
}